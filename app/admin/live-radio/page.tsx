    ...
    <div className="space-y-6 relative min-h-full">
      ...
      >
        ...
        <motion.button 
          ...
          className={`${streamConfig?.isOnline ? 'bg-red-600 hover:bg-red-500 shadow-[0_0_20px_rgba(220,38,38,0.4)]' : 'bg-emerald-600 hover:bg-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.4)]'} text-white font-bold text-xs sm:text-sm px-5 sm:px-6 py-2.5 rounded-xl transition-all flex items-center justify-center gap-2 w-full sm:w-auto`}
        >
